...
- date:, date:date and date:time are generated by DateTimeFormat instead
of other older methods.
- slice: moved to core plugin to cover both string and array (breaking)
- pad: new filter to call padStart/padEnd
- canonical methods are no longer allowed
